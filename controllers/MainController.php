...
class MainController extends Controller
{
    ...
    public function actionHome()
    {
       ...
       // try {
        ...
        //} catch (\Exception $e) {
            //Yii::error("Erro ao obter o uniqueId: " . $e->getMessage());
        //}
    ...
    public function actionSegundaOrdemTest1()
{
    ...
    if ($model->load($post) && $model->validate() && $model->periodo) {
        ...
        if (empty($cursor_by_price)) {
            return $this->render('error-view', ['message' => 'Nenhum dado encontrado para o período selecionado.']);
        }
    ...
    return $this->render('action-test1');
}


    //public function actionSegundaOrdem(){
       // $this->layout = 'navbar';
       ...
       // $post = $_POST;
        //if ($model->load($post) && $model->validate()) {
           ...
           // $start = Paper::toIsoDate($start->getTimestamp());
            ...
            //$cursor_by_price = $model->getData($sctock, $start, $final);
